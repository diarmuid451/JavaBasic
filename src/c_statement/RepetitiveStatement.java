...
public class RepetitiveStatement {
	...
	public static void main(String[] args) {
		...
		for(int i = 1; i <=10; i++){
		 ...
		 for (int i = 0; i < 10; i++) {//i가 5보다 작을 때 까지 i를 증가시켜라
	            ...
	            for (int k = 9; k >= i; k--) {//k는 4, k가 i보다 작을 때 k는 1씩 감소
...
//		Scanner s = new Scanner(System.in);
//		do{
//			System.out.println("1~100 사이의 수를 입력해세요.");
