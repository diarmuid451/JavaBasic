...
//---------------------------------------------------------------------- 		
		...
		students.add("김지선");students.add("이누리");students.add("정대석");students.add("박종민");students.add("정재영");
		students.add("강현철");students.add("주향한");students.add("윤창훈");students.add("연은주");students.add("김령환");
		students.add("구한나");students.add("백종빈");students.add("이병훈");students.add("강현지");students.add("김경운");
		students.add("이지형");students.add("이예림");students.add("이승재");students.add("민태홍");students.add("정보람");
		students.add("박진영");
