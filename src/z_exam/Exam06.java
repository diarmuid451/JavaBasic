...
public class Exam06 { 
	public static int abs(int value){ //6-24 메서드		
		return value >=0 ? value : -value;
		
	}
	
	public static int max(int[] arr){ //6-23 메서드
	...
	public static boolean isNumber(String str){	//6-22 메서드
	...
	public static int[] shuffle(int[] arr) { //6-20 메서드
		if(arr == null || arr.length==0)
		return arr;
	...
	public static String change(String str) { //6-19
		str += "456";
		return str;
		//>> String 타입이기 때문에 str 주소가 변경
	}
	
	public static void change1(int xx) { 
		xx += 456;
...
//		
		...
		change1(xx);
		System.out.println("After change:"+ xx);
