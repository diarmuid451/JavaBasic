...
public class InnerClass {
	...
	public static void main(String[] args) {
		 ...
		 * - 지역 클래스 : 메서드나 초기화 블럭 안에 선언하며, 선언된 영역 내부에서만 사용될  수 있다.
...
class Outer{
	...
	class InstanceInner{
		...
		void method(){
			...
			System.out.println(this.var); //내부클래스의 인스턴스 변수
			System.out.println(Outer.this.var); //바깥 클래스의 인스턴스변수
...
//		int inner1 = instanceVar;
	...
	void method(){
		...
		//지역 클래스
		class LocalInner{
			//지역 클래스에서는 인스턴스 멤버와 클래스 멤버 모두 사용 가능하고 final이 붙은 지역 변수도 사용 가능
			int inner1 = instanceVar;
			int inner2 = classVar;
