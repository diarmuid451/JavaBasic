...
public class ABC {
	...
	public static void main(String[] args) {
			...
			//실행할 문장을 메서드 안에 넣는다.
			System.out.println("Hello, world" + " ad" + 123); //괄호안에 있는 내용을 콘솔창에 출력하는 메서드
			System.out.print("Hello, world"); //줄바꿈을 하지 않는다.
			System.out.printf("Hello, world"); //줄바꿈을 하지 않는다.
			//코딩 : 코드를 작성하는 것				//main메서드의 마지막 문장까지 수행되면 프로그램은 종료된다.
			
			//예약어(키워드) : 자바에서 사용하는 특별 의미와 기능을 가진 단어(진한글씨)
			
			//코도는 영문을 사용하기 때문에 영타연습이 필요하다. 최소한 200타 이상 나오도록 연습하자	
	}
